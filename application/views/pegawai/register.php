...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url(); ?>"><b>Absensi Pegawai KKP</b> <br> Kantor Kesehatan Pelabuhan</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <div class="form-group has-feedback">
                <input type="number" class="form-control" name="email" placeholder="Masukan NIP / No. Kontrak">
