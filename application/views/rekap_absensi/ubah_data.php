                        ...
                        <form class="form-horizontal" method="post" action="<?php echo site_url('Rekap_absensi/update_db/' . trim($data_absensi_pegawai->nip_no_kontrak) . '/' . $data_absensi_pegawai->tgl_hadir); ?>" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="time" name="time_datang" class="form-control" placeholder="" value="<?php echo $data_absensi_pegawai->time_datang; ?>"><a href="<?php echo site_url('Rekap_absensi/lupa_rekam/' . trim($data_absensi_pegawai->nip_no_kontrak) . '/' . $data_absensi_pegawai->tgl_hadir) ?>">Terlambat datang</a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-1 control-label">Telat</label>
                                    <div class="col-sm-3">
                                        <input type="text" name="telat" class="form-control" disabled value="
                                        <?php
                                        echo $data_absensi_pegawai->telat;
                                        ...
                                        // echo $diff->s . ' detik, ';
                                        ?>">
                                        <!-- <input type="text" name="telat" class="form-control" id="" disabled placeholder="" value="-<?php if ($diff->h == '0') {
                                                                                                                                            echo "00:";
                                                                                                                                        } else {
                                                                                                                                            echo $diff->h . ":";
                                                                                                                                        }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-11">
                                        <a href="<?php echo site_url('Rekap_absensi/cekFile/' . $data_absensi_pegawai->file_keterangan) ?>" target="_blank">Cek <?php echo $data_absensi_pegawai->file_keterangan; ?></a>
                            ...
                            <div class="box-footer">
                                <a href="<?php echo site_url('rekap_absensi') ?>" class="btn btn-default">Kembali</a>
